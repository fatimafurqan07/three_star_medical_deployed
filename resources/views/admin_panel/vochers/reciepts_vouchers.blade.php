                                        ...
                                        <td>
                                            <div style="display:flex;gap:5px;flex-direction:column;">
                                                <div style="display:flex;gap:5px;align-items:center;">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-outline-primary btn-quick-narration" title="Quick Add Narration" style="padding: 2px 6px; border-radius: 4px; line-height: 1.2;">
    ...
    <div class="modal fade" id="quickNarrationModal" tabindex="-1" aria-hidden="true" style="z-index: 1060;">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-3 shadow border-0">
                <div class="modal-header text-white" style="background: linear-gradient(135deg, #4f6ef7, #7b5ef8);">
                ...
                <form id="quickNarrationForm">
                    @csrf
                    <input type="hidden" name="expense_head" id="quick_expense_head" value="Receipts Voucher">
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            <label class="form-label fw-bold text-secondary">Voucher Type</label>
                            <input type="text" class="form-control bg-light border-0" value="Receipt Voucher" readonly>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="modal-footer border-0 p-3 bg-light">
                        ...
                        <button type="submit" class="btn text-white px-4 fw-bold" style="background: linear-gradient(135deg, #4f6ef7, #7b5ef8);">Save Narration</button>
                    </div>
                </form>
            </div>
        </div>
