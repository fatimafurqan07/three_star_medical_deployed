        ...
        <form id="productForm" action="{{ route('store-product') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="details-section">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control-pro fs-6 fw-bold" name="product_name" required placeholder="e.g. Paracetamol 500mg">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label-pro">Item Code <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control-pro" name="item_code" required placeholder="ITEM-001">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control-pro" name="hs_code">
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control-pro" name="mdr">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div id="colorHiddenInputs"></div>
                                </div>

                                <div class="col-12">
                                    <div class="d-flex gap-4 p-3 bg-light rounded border">
                                        <div class="form-check"><input class="form-check-input" type="checkbox" name="is_fridge" id="fridge" value="1"><label class="form-check-label small fw-bold" for="fridge">Fridge Item</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" name="is_non_fridge" id="non_fridge" value="1"><label class="form-check-label small fw-bold" for="non_fridge">Non-Fridge Item</label></div>
                                        <div class="vr mx-2 text-muted opacity-25"></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" name="is_fast_moving" id="fast_moving" value="1"><label class="form-check-label small fw-bold" for="fast_moving">Fast Moving</label></div>
                                        <div class="form-check"><input class="form-check-input" type="checkbox" name="is_slow_moving" id="slow_moving" value="1"><label class="form-check-label small fw-bold" for="slow_moving">Slow Moving</label></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="section-card">
                ...
                <div class="card-body-pro p-0">
                    ...
                    <div id="packingEmptyState" class="text-center py-5 text-muted border-top">
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$('#barcodeInput').val()) generateBarcode();
